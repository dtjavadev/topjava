...
public class ExceptionInfoHandler {
    ...
    public static final String DUPLICATE_EMAIL = "exception.duplicate.email";
    public static final String DUPLICATE_DATETIME = "exception.duplicate.datetime";
    ...
    private static final Map<String, String> CONSTRAINS_MAP = Map.of(
            ...
            "meals_unique_user_datetime_idx", DUPLICATE_DATETIME);
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String... errors) {
        ...
        return new ErrorInfo(req.getRequestURL(), errorType,
                errors.length != 0 ? errors : new String[]{rootCause.toString()});
    }
}